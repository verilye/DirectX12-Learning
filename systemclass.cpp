...
bool SystemClass::Initialize() {
	...
	//Create and initialise the input object this object will be used to handle reading the keyboard input from the user
	m_Input = new InputClass;

	m_Input->Initialize();

	// Create nad initialise the application class object. This object will handle rendering all the graphics fro this application.
...
LRESULT CALLBACK SystemClass::MessageHandler(HWND hwnd, UINT umsg, WPARAM wparam, LPARAM lparam) {
	switch (umsg) {
		...
		//Chec if a key has been released on the keyboard
		case WM_KEYUP:
		{
